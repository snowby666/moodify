...
class Recommender(object):
    ...
    def limit(self, limit):
        if limit > 100:
            logger.warning("Maximum target size is 100.")
        self._limit = limit
    ...
    def genres(self, genres):
        ...
        if not self._genres:
            logger.warning("No matching seeds found for given genre.")
    ...
    def artists(self, artists):
        ...
        if not self._artist_ids:
            logger.warning("No matching seeds found for given artist.")
    ...
    def tracks(self, tracks):
        ...
        if not self._track_ids:
            logger.warning("No matching seeds found for given track.")
    ...
    def _lookup_track_id(self, track):
        ...
        logger.warning("No results found for: %s" % track)
    ...
    def _lookup_artist_id(self, artist_name):
        ...
        logger.warning("No results found for: %s" % artist_name)
